module Internal.Api.V1_4.Objects exposing
    ( BlindEvent
...
Last generated at Unix time 1671710296
...
{-| ClientEventWithoutRoomId that is a BlindEvent in older versions, forcing some values to be optional.
-}
...
roomsDecoder =
    D.map4
        ...
        (D.field "invite" (D.dict (D.list strippedStateEventDecoder)))
        (opFieldWithDefault "join" Dict.empty (D.dict joinedRoomDecoder))
        (D.field "knock" (D.dict (D.list strippedStateEventDecoder)))
